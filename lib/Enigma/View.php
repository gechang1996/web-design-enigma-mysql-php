...
HTML;
        ...
        if(($this->page !== self::INDEX) and ($this->page !== self::VALIDATE) and ($this->page !== self::NEWUSER) and($this->page !== self::NEWUSERPENDING)) {
            $html .= $this->nav();
        }
...
HTML;
	...
	private function nav() {
        $links = [
            ...
            ['to'=>'send.php', 'text'=>'Send', 'page'=>self::SEND],
            ['to'=>'receive.php', 'text'=>'Receive', 'page'=>self::RECEIVE],
