...
class BatchController extends Controller {
	 ...
	 */
	public function __construct(System $system, array $post,array &$session) {
        ...
        if(!empty($post['encode'])) {
            ...
            $this->encode($from);
            $session["batch_enc"]=$system->getEncoded();
            $session["batch_dec"]=$from;
        ...
        if(!empty($post['decode'])) {
            ...
            $this->decode($to);
            $session["batch_dec"]=$system->getDecoded();
            $session["batch_enc"]=$to;
        }
